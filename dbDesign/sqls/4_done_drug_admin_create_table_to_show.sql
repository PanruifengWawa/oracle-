...
create table record(
	...
	app_key 
			constraint record_app_key_fk references model(app_key),
	user_id
			constraint record_user_id_fk references iuser(id),
	idate date
			default trunc(SYSDATE)
...
create table daily_records(
	...
	app_key varchar2(256)
			constraint daily_app_key_fk references model(app_key),
	idate date
			default trunc(SYSDATE)
